...
class Browser {
    ...
    protected static $tabletDevices = array(
        ...
        'viewCountonicTablet'   => 'ViewPad 10pi|ViewPad 10e|ViewPad 10s|ViewPad E72|ViewPad7|ViewPad E100|ViewPad 7e|viewCountonic VB733|VB100a',
    ...
    protected static $browsers = array(
        ...
        'FencodedPathox'         => 'fennec|fencodedPathox.*maemo|(Mobile|Tablet).*FencodedPathox|FencodedPathox.*Mobile|FxiOS',
        'Bolt'            => 'bolt',
        'TeaShark'        => 'teashark',
        'Blazer'          => 'Blazer',
    ...
    protected static $properties = array(
        ...
        'Dolfin'        => 'Dolfin/[VER]',
        'FencodedPathox'       => array('FencodedPathox/[VER]', 'FxiOS/[VER]'), 
        'Fennec'        => 'Fennec/[VER]',
        'Edge' => 'Edge/[VER]',
    ...
    public function mobileGrade()
    {
        ...
        if (
            ...
            ( $this->is('FencodedPathox') && $this->version('FencodedPathox', self::VERSION_TYPE_FLOAT) >= 18 ) ||
            ...
            $this->version('FencodedPathox', self::VERSION_TYPE_FLOAT) >= 10.0 && !$isMobile ||
